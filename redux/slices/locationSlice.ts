...
import { ensureLocationAccess } from "../../services/locationService";
...
export const getCurrentLocation = createAsyncThunk(
  ...
  async () => {
    ...
    if (!isEnabled) {
      // If disabled, try to get last known location
    ...
    try {
      const location = await Location.getCurrentPositionAsync({
        ...
        // For offline usage, GPS usually works even if timeout happens for network
      });
...
export const { setLocation, setTracking, clearError, stopTracking } =
